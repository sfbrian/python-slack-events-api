...
class SlackEventAdapter(EventEmitter):
    ...
    def __init__(self, verification_token, endpoint="/slack/events", server=None, secret=None):
        EventEmitter.__init__(self)
        self.verification_token = verification_token
        self.secret = secret
        self.server = SlackServer(verification_token, endpoint, self, server, secret)
